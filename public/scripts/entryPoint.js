(function () {
  ...
  if (faCss && !document.querySelector(`link[href="${faCss}"]`)) {
      ...
      link.rel = "stylesheet";
      link.href = faCss;
      link.onload = () => console.log(`✅ FontAwesome CSS dimuat: ${faCss}`);
      link.onerror = () => console.error(`❌ Gagal memuat FontAwesome CSS: ${faCss}`);
  ...
  const loadScript = (src) =>
      new Promise((resolve, reject) => {
          ...
          script.async = true;  // Menjadikan pemuatan lebih cepat (asynchronous)
